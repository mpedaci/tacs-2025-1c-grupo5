...
public class ChoosingValueCommand implements StateCommand {
    ...
    public ChoosingValueCommand(IGameService gameService) {
    ...
    private void setupCardSelection(String cardName, ChatData chatData, ResponseHandler handler) {
        List<CardOutputDto> cards = gameService.findCards(chatData.getToken(), chatData.getGameId().toString(), cardName);
